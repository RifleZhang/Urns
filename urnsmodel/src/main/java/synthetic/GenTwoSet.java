...
public class GenTwoSet {
    ...
    public static void main(String args[]) {
        GenTwoSet g = new GenTwoSet();


        //double[] tc = {5.779,8.021,5.346,5.12,5.775,5.527,7.892,7.592,9.684,6.95};
        //double[] tzc = {1.279,1.2,1.184,1.395,1.378,1.392,1.495,1.522,0.888,0.925};
        //g.runML(10, tc, tzc);
